...
\alpha(j,J) = \braket{Z_0|\hat{S}_-|Z_0} %= g\sum_{k>0} u_kv_k \nonumber \\
 ...
 \label{Delta_BCS}
\end{align}
Using $\alpha$ as a coordinate is equivalent to using pairing gap $\Delta$ as a coordinate because the relation
\begin{align}
...
For very large $\Omega$, this is the case (See Fig. \ref{fig:Delta_E}, left panels).
