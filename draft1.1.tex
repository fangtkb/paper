...
\begin{figure}[htbp]
 \begin{center}
%  \includegraphics[width=60mm,angle=-90]{images/N50ex_energy.eps}
 \end{center}
...
\begin{figure}[htbp]
 ...
 \begin{center}
%  \includegraphics[width=67mm,angle=-90]{images/N50Xeq0p5occ_woType2.eps}
 \end{center}
 \end{minipage}
 \begin{minipage}{1\hsize}
 \begin{center}
%  \includegraphics[width=67mm,angle=-90]{images/N50Xeq2occ_woType2.eps}
 \end{center}
 \end{minipage}
...
\begin{figure}[htbp]
 ...
 \begin{center}
%  \includegraphics[width=70mm,angle=-90]{images/N50Pad_exact.eps}
 \end{center}
 \captionsetup{labelformat=empty,labelsep=none}
 \end{minipage}
 \begin{minipage}{0.33\hsize}
 \begin{center}
%  \includegraphics[width=70mm,angle=-90]{images/N50Pad_Type1.eps}
 \end{center}
 \captionsetup{labelformat=empty,labelsep=none}
 \end{minipage}
 \begin{minipage}{0.33\hsize}
 \begin{center}
%  \includegraphics[width=70mm,angle=-90]{images/N50Pad_semiclassical.eps}
 \end{center}
 \captionsetup{labelformat=empty,labelsep=none}
 \end{minipage}
...
\begin{figure}[htbp]
 \begin{center}
%  \includegraphics[width=60mm,angle=-90]{images/N8ex_energy.eps}
 \end{center}
...
\begin{figure}[htbp]
 \begin{minipage}{1\hsize}
 \begin{center}
%  \includegraphics[width=67mm,angle=-90]{images/N8Xeq0p5occ_woType2.eps}
 \end{center}
 \end{minipage}
 \begin{minipage}{1\hsize}
 \begin{center}
%  \includegraphics[width=67mm,angle=-90]{images/N8Xeq2occ_woType2.eps}
 \end{center}
 \end{minipage}
...
\begin{figure}[htbp]
 \begin{minipage}{0.33\hsize}
 \begin{center}
%  \includegraphics[width=70mm,angle=-90]{images/N8Pad_exact.eps}
 \end{center}
 \captionsetup{labelformat=empty,labelsep=none}
 \end{minipage}
 \begin{minipage}{0.33\hsize}
 \begin{center}
%  \includegraphics[width=70mm,angle=-90]{images/N8Pad_Type1.eps}
 \end{center}
 \captionsetup{labelformat=empty,labelsep=none}
 \end{minipage}
 \begin{minipage}{0.33\hsize}
 \begin{center}
%  \includegraphics[width=70mm,angle=-90]{images/N8Pad_semiclassical.eps}
 \end{center}
 \captionsetup{labelformat=empty,labelsep=none}
 \end{minipage}
...
\begin{figure}[htbp]
 \begin{center}
%  \includegraphics[width=60mm,angle=-90]{images/N16ex_energy.eps}
 \end{center}
...
\begin{figure}[htbp]
 \begin{minipage}{1\hsize}
 \begin{center}
%  \includegraphics[width=67mm,angle=-90]{images/N16Xeq0p5occ_woType2.eps}
 \end{center}
 \end{minipage}
 \begin{minipage}{1\hsize}
 \begin{center}
%  \includegraphics[width=67mm,angle=-90]{images/N16Xeq2occ_woType2.eps}
 \end{center}
 \end{minipage}
...
\begin{figure}[htbp]
 \begin{minipage}{0.33\hsize}
 \begin{center}
%  \includegraphics[width=70mm,angle=-90]{images/N16Pad_exact.eps}
 \end{center}
 \captionsetup{labelformat=empty,labelsep=none}
 \end{minipage}
 \begin{minipage}{0.33\hsize}
 \begin{center}
%  \includegraphics[width=70mm,angle=-90]{images/N16Pad_Type1.eps}
 \end{center}
 \captionsetup{labelformat=empty,labelsep=none}
 \end{minipage}
 \begin{minipage}{0.33\hsize}
 \begin{center}
%  \includegraphics[width=70mm,angle=-90]{images/N16Pad_semiclassical.eps}
 \end{center}
 \captionsetup{labelformat=empty,labelsep=none}
 \end{minipage}
...
\begin{align}
\Delta(j,J) = g\braket{Z_0|\hat{S}_-|Z_0} %= g\sum_{k>0} u_kv_k \nonumber \\
	= g\sum_{l=1}^2 S_l\sqrt{1-q_l^2} . % = \Delta(\pi) .
 \label{Delta_BCS}
\end{align}
...
\begin{figure}[htbp]
 \begin{center}
%  \includegraphics[width=45mm,angle=-90]{images/N8p_Delta.eps}
 \end{center}
...
\begin{figure}[htbp]
 \begin{center}
%  \includegraphics[width=45mm,angle=-90]{images/N16p_Delta.eps}
 \end{center}
...
\begin{figure}[htbp]
 \begin{center}
%  \includegraphics[width=130mm,angle=-90]{images/Delta_compare.eps}
 \end{center}
