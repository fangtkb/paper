...
\title{Comparative study of the requantization of the time-dependent mean
field for the dynamics of nuclear pairing}
\author{Fang Ni}
...
described by the Bardeen-Cooper-Schrieffer (BCS)
...
\mathcal{L}(t) = \sum_l \frac{\Omega_l}{2}
  ...
  = \sum_l \epsilon_l\Omega_l(1- q_l)& - \frac{g}{4}\sum_l \Omega_l [\Omega_l(1-q_l^2)+(1-q_l)^2] \nonumber \\
...
\begin{align}
\mathcal{H}(\phi,j;J)
	=& \sum_{l=1,2} \Omega_l \epsilon_l(1- q_l) \nonumber \\
	&- \frac{g}{4}\sum_{l=1,2} \Omega_l [\Omega_l(1-q_l^2)+(1-q_l)^2] \nonumber \\
...
\ket{\psi(t)}
	...
	&\times \int_{Z(0)=Z'}^{Z(t)=Z''} \mathcal{D}\mu[Z(\tau)]
...
\begin{align}
	...
	&\times \left(Z_l^{(k)*} dZ_l^{(k)} - Z_l^{(k)} dZ_l^{(k)*}\right) \nonumber \\
	=& 2k\pi .
	\label{EBK}
\end{align}
...
\begin{align}
 ...
 &\times A(q_1,S_1,m)A(q_2,S_2,J-m) ,\\
  A(q,S,m) &= \left(\frac{1-q}{2}\right)^{m/2}\left(\frac{1+q}{2}\right)^{S-m/2}\sqrt{\frac{(2S)!m!}{(2S-m)!}}, \hspace{5mm} \nonumber
\end{align}
...
\begin{align}
 \mathcal{T}_{N,E_k}(\Phi\pm\pi,\phi\pm 2\pi;J) &= \mathcal{T}_{N,E_k}(\Phi,\phi;J) + 2m\pi \nonumber \\
	 \Leftrightarrow \quad\quad \pm \frac{N}{2} \pi + \int_{-\pi}^\pi j d\phi
	&= 2m\pi .
\end{align}
...
\begin{align}
	...
	\left\{ \sqrt{(1-q_{1}^2)(1-q_{2}^2)}\cos{\hat{\phi}} \right. \nonumber \\
	&\left. + \cos{\hat{\phi}}\sqrt{(1-q_{1}^2)(1-q_{2}^2)} \right\} .
...
(a)	 \includegraphics[height=0.44\textwidth,angle=-90]{N50ex_energy_wo_adiabatic.eps}
\\
(b)	 \includegraphics[height=0.44\textwidth,angle=-90]{N100ex_energy_wo_adiabatic.eps}
 \end{center}
...
\begin{figure}[t]
 \begin{center}
  \includegraphics[height=0.46\textwidth,angle=-90]{N8ex_energy_wo_adiabatic.eps}
 \end{center}
 \caption{Excitation energies of $\ket{0_2^+}$, $\ket{0_3^+}$ and
...
\begin{figure}[htbp]
 \begin{minipage}{1\hsize}
 \begin{center}
   \includegraphics[height=0.9\textwidth,angle=-90]{N8Xeq0p5occ_wo_adiabatic.eps}
   \includegraphics[height=0.9\textwidth,angle=-90]{N8Xeq2occ_wo_adiabatic.eps}
 \end{center}
 \end{minipage}
 \caption{
...
\begin{figure}[htb]
 \begin{center}
  \includegraphics[height=0.46\textwidth,,angle=-90]{N16ex_energy_wo_adiabatic.eps}
 \end{center}
...
\begin{figure}[thb]
 \begin{minipage}{1\hsize}
 \begin{center}
   \includegraphics[height=0.9\textwidth,angle=-90]{N16Xeq0p5occ_wo_adiabatic.eps}
   \includegraphics[height=0.9\textwidth,angle=-90]{N16Xeq2occ_wo_adiabatic.eps}
 \end{center}
 \end{minipage}
...
\begin{figure}[tb]
 \begin{center}
(a) \includegraphics[height=0.44\textwidth,angle=-90]{N8p_E.eps}
\\
(b) \includegraphics[height=0.44\textwidth,angle=-90]{N16p_E.eps}
 \end{center}
...
% \begin{minipage}{0.45\hsize}
 \begin{center}
(a) \includegraphics[height=0.4\textwidth,angle=-90]{N50Xeq2p4gap_E.eps}
\\
% \end{center}
% \end{minipage}
% \begin{minipage}{0.45\hsize}
% \begin{center}
(b) \includegraphics[height=0.4\textwidth,angle=-90]{N16Xeq2p4gap_E.eps}
 \end{center}
%\end{minipage}
