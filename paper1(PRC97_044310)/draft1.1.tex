...
\begin{abstract}
In order to obtain quantal information, such as energy eigenvalues
...
proposed \cite{Neg80,KS80,K81,Rei80}.
...
takes place at $x=1$.\footnote{$x$ is common definition of dimensionless coupling constant. Strictly, the exact phase transition point is $x=2\Omega/(2\Omega-1)$. }
...
\begin{figure}[htbp]
 \begin{minipage}{1\hsize}
 \begin{center}
  \includegraphics[width=67mm,angle=-90]{images/N8Xeq0p5occ_wo_adiabatic.eps}
 \end{center}
 \end{minipage}
 \begin{minipage}{1\hsize}
 \begin{center}
  \includegraphics[width=67mm,angle=-90]{images/N8Xeq2occ_wo_adiabatic.eps}
 \end{center}
 \end{minipage}
...
\begin{figure}[htbp]
 \begin{minipage}{1\hsize}
 \begin{center}
  \includegraphics[width=67mm,angle=-90]{images/N16Xeq0p5occ_wo_adiabatic.eps}
 \end{center}
 \end{minipage}
 \begin{minipage}{1\hsize}
 \begin{center}
  \includegraphics[width=67mm,angle=-90]{images/N16Xeq2occ_wo_adiabatic.eps}
 \end{center}
 \end{minipage}
